...
// Genis whitelist: eml/msg + yaygin ek tipleri (standalone attachment tarama).
...
const ALLOWED_UPLOAD_EXTS = [
    ...
    'exe','dll','js','vbs','ps1','bat','cmd','sh'  // ek tarama icin (buyuk ihtimal zararli)
];
...
const EML_ALLOWED_FORMATS = ['eml','msg','ole2','zip'];

// Multer hatalarini (LIMIT_FILE_SIZE, fileFilter reject) JSON 400/413'e cevirir.
